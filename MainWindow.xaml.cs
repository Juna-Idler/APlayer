...
namespace APlayer
{
    ...
    public sealed partial class MainWindow : Window
    {
        ...
        public async Task<bool> OpenVideoView(IStorageFile file,string? device_name)
        {
            await VideoView.SetAudioDevice(device_name);
            if (!VideoView.LoadVideo(file))
                return false;
            VideoView.Visibility = Visibility.Visible;
            VideoView.RequestedClose += VideoView_RequestedClose;
            return true;
        }
        private void VideoView_RequestedClose(object? sender, EventArgs e)
        {
